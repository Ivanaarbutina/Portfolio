      ...
      <div className="home__info">
        <div>
          ...
          <p className="home__description">
            ...
            Currently, I'm seeking a junior dev position to kick start my career
            and learn among professionals.
          </p>
          <Link to="https://www.linkedin.com/in/ivana-arbutina-340660285/">
            <img className="home__icon" src={LnIcon} alt="Linkedin icon" />
          </Link>
          <Link to="https://github.com/Ivanaarbutina">
